definition(
    name: "My Enhanced Auto Lock Door",
    namespace: "Lock Auto Super Enhanced",
    author: "fwadiver",
    description: "Automatically locks a specific door after X minutes when closed  and unlocks it when open after X seconds, unless seconds is 0",
...
def doorHandler(evt){
    if ((contact.latestValue("contact") == "open") && (evt.value == "locked")) { // If the door is open and a person locks the door then...  
        ...
        if (delay != "0") runIn( delay, unlockDoor )   // ...schedule (in minutes) to unlock...  We don't want the door to be closed while the lock is engaged. 
    }
